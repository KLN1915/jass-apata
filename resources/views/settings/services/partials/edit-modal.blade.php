<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('services.store') }}" method="POST" id="editForm">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input id="edit-name" type="text" name="name" class="form-control name" placeholder="Ingrese el nombre del servicio">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="edit-chargePeriod" name="chargePeriod" class="form-control">
                    ...
                    <div class="form-group form-check" id="edit-checkboxContainer">
                        {{-- checkbox condicional --}}
                    </div>
                    <div class="row" id="edit-finesContainer">
...
@push('js')
    @vite(['resources/js/settings/services/editService.js'])
@endpush